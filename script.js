        ...
        <div class="screen" id="screen2">
            ...
            <div class="product-section">
                <div id="productSearchArea">
                    ...
                    <button type="button" class="btn-action" id="btnFetchProduct" onclick="fetchProductBySku()">
                        <i class="fas fa-search"></i> Buscar
                    </button>
                    <div id="productFetchDisplay" style="display:none;">
                        ...
                        <button type="button" class="btn-add small-btn" onclick="addProductToListAndClearSearch()" id="btnAddProductToList" disabled>
        ...
        <div class="screen" id="screen3">
            ...
            <div class="entry-section">
                ...
                <div class="entry-options vertical-options">
                    <div class="option-item" onclick="selectEntryOption('none', this)">
                        <input type="radio" name="entryOption" id="entryOptNone" value="none" checked>
                        <label for="entryOptNone">Sem Entrada</label>
                    </div>
                    <div class="option-item" onclick="selectEntryOption('10', this)">
                    ...
                    <div class="option-item" onclick="selectEntryOption('20', this)">
                    ...
                    <div class="option-item" onclick="selectEntryOption('30', this)">
                    ...
                    <div class="option-item" onclick="selectEntryOption('custom', this)">
        ...
        <div class="screen" id="screen5">
            ...
            <div class="summary-container" id="operatorSummaryContainer">
                ...
                <div class="summary-section">
                    ...
                    <p><strong>Entrada:</strong> R$ <span id="summaryEntryAmount"></span> (<span id="summaryEntryPercentage"></span>%)</p>
                    <p><strong>Valor Financiado (base para cálculo):</strong> R$ <span id="summaryAmountFinancedInternal"></span></p>
                    <p><strong>Parcelamento:</strong> <span id="summaryInstallmentMonths"></span>x de R$ <span id="summaryInstallmentValue"></span></p>
                    <p><strong>Total Aproximado Pago no Carnê:</strong> R$ <span id="summaryTotalPaidCarnet"></span></p>
            ...
            <button type="button" class="btn-send whatsapp-btn" id="sendWppButton" onclick="sendWhatsAppMessage()">
